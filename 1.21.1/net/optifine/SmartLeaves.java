                ...
                else
                {
                    ...
                    if (bakedmodel != null && bakedmodel != modelmanager.getMissingModel())
                    {
                        ...
                        else
                        {
                            ...
                            {
                                List<BakedQuad> list1 = bakedmodel.getQuads(null, bakedquad.getDirection(), RANDOM);
        ...
        else
        {
            ...
            for (int k = 0; k < adirection.length; k++)
            {
                ...
                BakedQuad bakedquad1 = new BakedQuad(
                    (int[])bakedquad.getVertices().clone(), bakedquad.getTintIndex(), bakedquad.getDirection(), bakedquad.getSprite(), bakedquad.isShade()
                );
