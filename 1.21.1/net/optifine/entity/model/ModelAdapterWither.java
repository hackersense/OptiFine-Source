...
public class ModelAdapterWither extends ModelAdapter
{
    ...
    public ModelPart getModelRenderer(Model model, String modelPart)
    {
        ...
        {
            return witherbossmodel.root().getChildModelDeep("left_head");
        }
        else
        {
            return modelPart.equals("root") ? witherbossmodel.root() : null;
        }
    }
    ...
    public IEntityRenderer makeEntityRender(Model modelBase, float shadowSize, RendererCache rendererCache, int index)
    {
        ...
        witherbossrenderer.model = (WitherBossModel<WitherBoss>)modelBase;
