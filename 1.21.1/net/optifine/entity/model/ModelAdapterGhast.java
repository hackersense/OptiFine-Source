...
public class ModelAdapterGhast extends ModelAdapter
{
    ...
    public ModelPart getModelRenderer(Model model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return modelPart.equals("root") ? ghastmodel.root() : null;
            }
        }
    }
    ...
    public String[] getModelRendererNames()
    {
        return new String[]
               {
                   "body", "tentacle1", "tentacle2", "tentacle3", "tentacle4", "tentacle5", "tentacle6", "tentacle7", "tentacle8", "tentacle9", "root"
               };
    }
    ...
    public IEntityRenderer makeEntityRender(Model modelBase, float shadowSize, RendererCache rendererCache, int index)
    {
        ...
        ghastrenderer.model = (GhastModel<Ghast>)modelBase;
