...
public class Vec3 implements Position
{
    public static final Codec<Vec3> CODEC = Codec.DOUBLE
            .listOf()
            .comapFlatMap(
                p_318574_0_ -> Util.fixedSize((List<Double>)p_318574_0_, 3)
                .map(p_231080_0_ -> new Vec3(p_231080_0_.get(0), p_231080_0_.get(1), p_231080_0_.get(2))),
                p_231082_0_ -> List.of(p_231082_0_.x(), p_231082_0_.y(), p_231082_0_.z())
            );
