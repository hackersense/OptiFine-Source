...
public class EntitySectionStorage<T extends EntityAccess>
{
    ...
    {
        this.forEachAccessibleNonEmptySection(p_261820_, sectionIn -> sectionIn.getEntities(p_261820_, p_261992_));
    }

    public <U extends T> void getEntities(EntityTypeTest<T, U> p_261630_, AABB p_261843_, AbortableIterationConsumer<U> p_261742_)
    {
        this.forEachAccessibleNonEmptySection(p_261843_, sectionIn -> sectionIn.getEntities(p_261630_, p_261843_, p_261742_));
    }
