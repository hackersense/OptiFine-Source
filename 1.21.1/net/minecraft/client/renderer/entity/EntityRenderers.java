...
public class EntityRenderers
{
    ...
    public static Map < EntityType<?>, EntityRenderer<? >> createEntityRenderers(EntityRendererProvider.Context p_174050_)
    {
        ...
        {
            try {
                builder.put((EntityType<?>)typeIn, providerIn.create(p_174050_));
            }
    ...
    public static Map < PlayerSkin.Model, EntityRenderer <? extends Player >> createPlayerRenderers(EntityRendererProvider.Context p_174052_)
    {
        ...
        {
            try {
                builder.put(modelIn, providerIn.create(p_174052_));
            }
            catch (Exception exception)
            {
    ...
    static
    {
        ...
        register(EntityType.BOAT, p_174093_0_ -> new BoatRenderer(p_174093_0_, false));
        ...
        register(EntityType.CAMEL, contextIn -> new CamelRenderer(contextIn, ModelLayers.CAMEL));
        register(EntityType.CAVE_SPIDER, CaveSpiderRenderer::new);
        register(EntityType.CHEST_BOAT, p_174091_0_ -> new BoatRenderer(p_174091_0_, true));
        ...
        register(EntityType.DONKEY, p_174085_0_ -> new ChestedHorseRenderer<>(p_174085_0_, 0.87F, ModelLayers.DONKEY));
        ...
        register(EntityType.FIREBALL, p_174081_0_ -> new ThrownItemRenderer<>(p_174081_0_, 3.0F, true));
        ...
        register(EntityType.GLOW_SQUID, p_174075_0_ -> new GlowSquidRenderer(p_174075_0_, new SquidModel<>(p_174075_0_.bakeLayer(ModelLayers.GLOW_SQUID))));
        ...
        register(EntityType.LLAMA, p_174071_0_ -> new LlamaRenderer(p_174071_0_, ModelLayers.LLAMA));
        ...
        register(EntityType.MULE, p_174067_0_ -> new ChestedHorseRenderer<>(p_174067_0_, 0.92F, ModelLayers.MULE));
        ...
        register(
            EntityType.PIGLIN, p_174065_0_ -> new PiglinRenderer(p_174065_0_, ModelLayers.PIGLIN, ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false)
        );
        register(
            EntityType.PIGLIN_BRUTE, p_174063_0_ -> new PiglinRenderer(p_174063_0_, ModelLayers.PIGLIN_BRUTE, ModelLayers.PIGLIN_BRUTE_INNER_ARMOR, ModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, false)
        );
        ...
        register(EntityType.SKELETON_HORSE, p_174061_0_ -> new UndeadHorseRenderer(p_174061_0_, ModelLayers.SKELETON_HORSE));
        register(EntityType.SLIME, SlimeRenderer::new);
        register(EntityType.SMALL_FIREBALL, p_174059_0_ -> new ThrownItemRenderer<>(p_174059_0_, 0.75F, true));
        ...
        register(EntityType.SQUID, p_174055_0_ -> new SquidRenderer<>(p_174055_0_, new SquidModel<>(p_174055_0_.bakeLayer(ModelLayers.SQUID))));
        ...
        register(EntityType.TRADER_LLAMA, p_174053_0_ -> new LlamaRenderer(p_174053_0_, ModelLayers.TRADER_LLAMA));
        ...
        register(EntityType.ZOMBIE_HORSE, p_234611_0_ -> new UndeadHorseRenderer(p_234611_0_, ModelLayers.ZOMBIE_HORSE));
        register(EntityType.ZOMBIE_VILLAGER, ZombieVillagerRenderer::new);
        register(
            EntityType.ZOMBIFIED_PIGLIN, p_234609_0_ -> new PiglinRenderer(p_234609_0_, ModelLayers.ZOMBIFIED_PIGLIN, ModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, ModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true)
        );
    }
}
