...
public class CapeLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>>
{
    ...
    )
    {
        if (!p_116618_.isInvisible() && p_116618_.isModelPartShown(PlayerModelPart.CAPE))
        {
            ...
            if (p_116618_.getLocationCape() != null)
            {
                ...
                if (!itemstack.is(Items.ELYTRA))
                {
                    ...
                    p_116618_.capeRotateX = Mth.lerp(f5, p_116618_.capeRotateX, 6.0F + f2 / 2.0F + f1);
                    p_116618_.capeRotateZ = Mth.lerp(f5, p_116618_.capeRotateZ, f3 / 2.0F);
                    p_116618_.capeRotateY = Mth.lerp(f5, p_116618_.capeRotateY, 180.0F - f3 / 2.0F);
                    p_116615_.mulPose(Axis.XP.rotationDegrees(p_116618_.capeRotateX));
                    p_116615_.mulPose(Axis.ZP.rotationDegrees(p_116618_.capeRotateZ));
                    p_116615_.mulPose(Axis.YP.rotationDegrees(p_116618_.capeRotateY));
                    VertexConsumer vertexconsumer = p_116616_.getBuffer(RenderType.entitySolid(p_116618_.getLocationCape()));
