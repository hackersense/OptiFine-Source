...
public class EffectInstance implements Effect, AutoCloseable
{
    ...
    public EffectInstance(ResourceProvider p_334130_, String p_108942_) throws IOException
    {
        ...
        {
            resourcelocation = ResourceLocation.tryParse(p_108942_).withPath(p -> "shaders/program/" + p + ".json");
        }
    ...
    public static EffectProgram getOrCreate(ResourceProvider p_331503_, Program.Type p_172568_, String p_172569_) throws IOException
    {
        ...
        else
        {
            ...
            if (program == null)
            {
                ...
                if (Reflector.MinecraftForge.exists())
                {
                    resourcelocation = ResourceLocation.tryParse(p_172569_).withPath(p -> "shaders/program/" + p + p_172568_.getExtension());
                }
