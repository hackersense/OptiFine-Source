...
public class FogRenderer
{
    ...
    public static void setupColor(Camera p_109019_, float p_109020_, ClientLevel p_109021_, int p_109022_, float p_109023_)
    {
        ...
        else
        {
            ...
            vec3 = CustomColors.getWorldSkyColor(vec3, p_109021_, p_109019_.getEntity(), p_109020_);
            ...
            Vec3 vec33 = p_109019_.getPosition().subtract(2.0, 2.0, 2.0).scale(0.25);
            Vec3M vec3m = new Vec3M(0.0, 0.0, 0.0);
            Vec3 vec34 = CubicSampler.sampleM(vec33, (xIn, yIn, zIn) ->
            {
                int i2 = biomemanager.getNoiseBiomeAtQuart(xIn, yIn, zIn).value().getFogColor();
                vec3m.fromRgbM(i2);
                return p_109021_.effects().getBrightnessDependentFogColor(vec3m, f11);
            });
            vec34 = p_109021_.effects().getBrightnessDependentFogColor(vec34, f11);
            vec34 = CustomColors.getWorldFogColor(vec34, p_109021_, p_109019_.getEntity(), p_109020_);
            ...
            if (p_109022_ >= 4)
            {
                ...
                float f16 = p_109019_.getLookVector().dot(vector3f1);
        ...
        if (fogtype == FogType.WATER)
        {
            Entity entity1 = p_109019_.getEntity();
            Vec3 vec31 = CustomColors.getUnderwaterColor(p_109021_, entity1.getX(), entity1.getY() + 1.0, entity1.getZ());
        ...
        {
            Entity entity2 = p_109019_.getEntity();
            Vec3 vec32 = CustomColors.getUnderlavaColor(p_109021_, entity2.getX(), entity2.getY() + 1.0, entity2.getZ());
        ...
        {
            Vector3f vector3f = (Vector3f)Reflector.ForgeHooksClient_getFogColor
                                .call(p_109019_, p_109020_, p_109021_, p_109022_, p_109023_, fogRed, fogGreen, fogBlue);
            fogRed = vector3f.x();
            fogGreen = vector3f.y();
            fogBlue = vector3f.z();
        }
    ...
    private static FogRenderer.MobEffectFogFunction getPriorityFogFunction(Entity p_234166_, float p_234167_)
    {
        return p_234166_ instanceof LivingEntity livingentity
               ? MOB_EFFECT_FOG.stream().filter(fogFunctionIn -> fogFunctionIn.isEnabled(livingentity, p_234167_)).findFirst().orElse(null)
               : null;
    }
    ...
    public static void setupFog(Camera p_234173_, FogRenderer.FogMode p_234174_, float p_234175_, boolean p_234176_, float p_234177_)
    {
        ...
        {
            fogrenderer$fogdata.start = 0.0F;
            fogrenderer$fogdata.end = Math.min(p_234175_, 512.0F);
            fogrenderer$fogdata.shape = FogShape.CYLINDER;
        }
        else
        {
            ...
            fogrenderer$fogdata.start = p_234175_ * Config.getFogStart();
            fogrenderer$fogdata.end = p_234175_;
            fogrenderer$fogdata.shape = FogShape.CYLINDER;
        }
