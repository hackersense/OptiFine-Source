...
public class CycleButton<T> extends AbstractButton implements IOptionControl
{
    ...
    private void cycleValue(int p_168909_)
    {
        ...
        {
            iteratableoptionof.nextOptionValue(p_168909_);
        }
    ...
    {
        return new CycleButton.Builder<Boolean>(p_168899_2_ -> p_168899_2_ ? p_168897_ : p_168898_).withValues(BOOLEAN_OPTIONS);
    }
    ...
    public static class Builder<T>
    {
        ...
        {
            return this.create(p_168931_, p_168932_, p_168933_, p_168934_, p_168935_, (p_168945_0_, p_168945_1_) ->
            {
            });
        }
