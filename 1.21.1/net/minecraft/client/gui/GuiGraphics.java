...
public class GuiGraphics implements IForgeGuiGraphics
{
    ...
    public int drawString(Font font, @Nullable String text, float x, float y, int color, boolean shadow)
    {
        ...
        else
        {
            int i = font.drawInBatch(
                        text, x, y, color, shadow, this.pose.last().pose(), this.bufferSource, Font.DisplayMode.NORMAL, 0, 15728880, font.isBidirectional()
                    );
            this.flushIfUnmanaged();
            return i;
        }
    ...
    public void renderItemDecorations(Font p_282005_, ItemStack p_283349_, int p_282641_, int p_282146_, @Nullable String p_282803_)
    {
        if (!p_283349_.isEmpty())
        {
            ...
            {
                int j = p_283349_.getBarWidth();
                int i = p_283349_.getBarColor();

                if (Config.isCustomColors())
                {
                    float f = (float)p_283349_.getDamageValue();
                    float f1 = (float)p_283349_.getMaxDamage();
                ...
                this.fill(RenderType.guiOverlay(), k, i1, k + j, i1 + 1, i | 0xFF000000);
            }

            LocalPlayer localplayer = this.minecraft.player;
            float f3 = localplayer == null ? 0.0F : localplayer.getCooldowns().getCooldownPercent(p_283349_.getItem(), this.minecraft.getTimer().getGameTimeDeltaPartialTick(true));

            if (f3 > 0.0F)
            {
                int l = p_282146_ + Mth.floor(16.0F * (1.0F - f3));
                int j1 = l + Mth.ceil(16.0F * f3);
                this.fill(RenderType.guiOverlay(), p_282641_, l, p_282641_ + 16, j1, Integer.MAX_VALUE);
            }
            ...
            {
                Object object = Reflector.call(Reflector.ItemDecoratorHandler_of, p_283349_);
                Reflector.call(object, Reflector.ItemDecoratorHandler_render, this, p_282005_, p_283349_, p_282641_, p_282146_);
            }
        }
    }
    ...
    public void renderTooltip(Font p_283128_, List<Component> p_282716_, Optional<TooltipComponent> p_281682_, int p_283678_, int p_281696_)
    {
        ...
        p_281682_.ifPresent(compIn -> list.add(list.isEmpty() ? 0 : 1, ClientTooltipComponent.create(compIn)));
        ...
        if (Reflector.ForgeHooksClient_gatherTooltipComponents7.exists())
        {
            List list1 = (List)Reflector.ForgeHooksClient_gatherTooltipComponents7
                         .call(this.tooltipStack, p_282716_, p_281682_, p_283678_, this.guiWidth(), this.guiHeight(), p_283128_);
            list.clear();
            list.addAll(list1);
        }
    ...
    public void renderComponentTooltip(Font p_282739_, List<Component> p_281832_, int p_282191_, int p_282446_)
    {
        if (Reflector.ForgeHooksClient_gatherTooltipComponents6.exists())
        {
            List<ClientTooltipComponent> list = (List<ClientTooltipComponent>)Reflector.ForgeHooksClient_gatherTooltipComponents6
                                                .call(this.tooltipStack, p_281832_, p_282191_, this.guiWidth(), this.guiHeight(), p_282739_);
            this.renderTooltipInternal(p_282739_, list, p_282191_, p_282446_, DefaultTooltipPositioner.INSTANCE);
        }
        else
        {
        ...
        if (!p_282615_.isEmpty())
        {
            ...
            if (Reflector.ForgeHooksClient_onRenderTooltipPre.exists())
            {
                event = (Event)Reflector.ForgeHooksClient_onRenderTooltipPre
                        .call(this.tooltipStack, this, p_283230_, p_283417_, this.guiWidth(), this.guiHeight(), p_282615_, p_282675_, p_282442_);
            ...
            for (ClientTooltipComponent clienttooltipcomponent : p_282615_)
            {
                if (event != null)
                {
                    p_282675_ = (Font)Reflector.call(event, Reflector.RenderTooltipEvent_getFont);
                }
            ...
            if (event != null)
            {
                p_283230_ = Reflector.callInt(event, Reflector.RenderTooltipEvent_getX);
                p_283417_ = Reflector.callInt(event, Reflector.RenderTooltipEvent_getY);
            }
            ...
            this.drawManaged(() ->
            {
                ...
                {
                    Object object = Reflector.ForgeHooksClient_onRenderTooltipColor.call(this.tooltipStack, this, l, i1, font, p_282615_);
                    int l2 = Reflector.callInt(object, Reflector.RenderTooltipEvent_Color_getBackgroundStart);
                    int i3 = Reflector.callInt(object, Reflector.RenderTooltipEvent_Color_getBackgroundEnd);
                    int j3 = Reflector.callInt(object, Reflector.RenderTooltipEvent_Color_getBorderStart);
                    int k3 = Reflector.callInt(object, Reflector.RenderTooltipEvent_Color_getBorderEnd);
