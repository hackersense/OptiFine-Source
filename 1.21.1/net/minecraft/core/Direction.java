...
public enum Direction implements StringRepresentable
{
    ...
    public static Direction getFacingAxis(Entity p_175358_, Direction.Axis p_175359_)
    {
        ...
        {
            case X -> EAST.isFacingAngle(p_175358_.getViewYRot(1.0F)) ? EAST :
                    WEST;

            case Y -> p_175358_.getViewXRot(1.0F) < 0.0F ? UP :
                    DOWN;

            case Z -> SOUTH.isFacingAngle(p_175358_.getViewYRot(1.0F)) ? SOUTH :
                    NORTH;
        };
    }
    ...
    public Direction getClockWise(Direction.Axis p_175363_)
    {
        ...
        {
            case X -> this != WEST && this != EAST ? this.getClockWiseX() :
                    this;

            case Y -> this != UP && this != DOWN ? this.getClockWise() :
                    this;
    ...
    public Direction getCounterClockWise(Direction.Axis p_175365_)
    {
        ...
        {
            case X -> this != WEST && this != EAST ? this.getCounterClockWiseX() :
                    this;

            case Y -> this != UP && this != DOWN ? this.getCounterClockWise() :
                    this;
    ...
    public static Direction fromAxisAndDirection(Direction.Axis p_122388_, Direction.AxisDirection p_122389_)
    {
        ...
        {
            case X -> p_122389_ == Direction.AxisDirection.POSITIVE ? EAST :
                    WEST;

            case Y -> p_122389_ == Direction.AxisDirection.POSITIVE ? UP :
                    DOWN;

            case Z -> p_122389_ == Direction.AxisDirection.POSITIVE ? SOUTH :
                    NORTH;
        };
    }
    ...
    public static enum Axis implements StringRepresentable, Predicate<Direction> {
        ...
        private Axis(final String p_122456_)
        {
            this.name = p_122456_;
        }
