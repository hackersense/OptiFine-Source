...
public class Mth
{
    ...
    {
        return fastMath ? SIN_TABLE_FAST[(int)(p_14032_ * radToIndex) & 4095] : SIN[(int)(p_14032_ * 10430.378F) & 65535];
    }

    public static float cos(float p_14090_)
    {
        return fastMath ? SIN_TABLE_FAST[(int)(p_14090_ * radToIndex + 1024.0F) & 4095] : SIN[(int)(p_14090_ * 10430.378F + 16384.0F) & 65535];
    }
    ...
    public static IntStream outFromOrigin(int p_216251_, int p_216252_, int p_216253_, int p_216254_)
    {
        ...
        {
            return p_216251_ >= p_216252_ && p_216251_ <= p_216253_ ? IntStream.iterate(p_216251_, p_216278_3_ ->
            {
                int i = Math.abs(p_216251_ - p_216278_3_);
                return p_216251_ - i >= p_216252_ || p_216251_ + i <= p_216253_;
            }, p_216255_4_ ->
            {
                boolean flag = p_216255_4_ <= p_216251_;
                int i = Math.abs(p_216251_ - p_216255_4_);
