...
public class ActiveProfiler implements ProfileCollector
{
    ...
    public void push(String p_18390_)
    {
        ...
        {
            int i = p_18390_.hashCode();

            if (i == HASH_SCHEDULED_EXECUTABLES && p_18390_.equals("scheduledExecutables"))
            {
                Lagometer.timerScheduledExecutables.start();
            }
            else if (i == HASH_TICK && p_18390_.equals("tick") && Config.isMinecraftThread())
            {
    ...
    public void popPush(String p_18395_)
    {
        if (this.lagometerActive)
        {
            int i = p_18395_.hashCode();

            if (i == HASH_SOUND && p_18395_.equals("sound"))
            {
