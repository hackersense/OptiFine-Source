...
public final class NativeImage implements AutoCloseable
{
    ...
    public static void setFilter(boolean p_85082_, boolean p_85083_)
    {
        ...
        if (updateBlurMipmap)
        {
            ...
            else
            {
                ...
                GlStateManager._texParameter(3553, 10241, p_85083_ ? i : 9728);
        ...
        else
        {
            ...
            else
            {
                ...
                for (int l = 0; l < k; l++)
                {
                    ...
                    MemoryUtil.memCopy(p_85055_.pixels + (long)i1, this.pixels + (long)j1, (long)j * (long)i);
                }
            }
        }
    }
