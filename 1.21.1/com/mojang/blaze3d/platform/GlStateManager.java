...
public class GlStateManager
{
    ...
    public static void _glBindFramebuffer(int p_84487_, int p_84488_)
    {
        ...
        if (p_84487_ == 36160)
        {
            if (framebufferRead == p_84488_ && framebufferDraw == p_84488_)
            {
                return;
            }

            framebufferRead = p_84488_;
            framebufferDraw = p_84488_;
        }
        else if (p_84487_ == 36008)
        {
            if (framebufferRead == p_84488_)
            {
                return;
            }
    ...
    public static void _bindTexture(int p_84545_)
    {
        ...
        if (p_84545_ != TEXTURES[activeTexture].binding)
        {
            ...
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, p_84545_);

            if (SmartAnimations.isActive())
            {
                SmartAnimations.textureRendered(p_84545_);
            }
        }
    }
    ...
    )
    {
        try
        {
            ...
            GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, p_287672_, p_287577_, p_287618_, p_287777_, p_287707_, p_287692_.glFormat(), GL11.GL_UNSIGNED_BYTE, p_287674_);
        }
        finally
        {
